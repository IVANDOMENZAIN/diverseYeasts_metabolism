...
writetable(secretions,['../results/randomSampling_' csoure '_growth_secretions.txt'],'delimiter','\t','QuoteStrings',false)
writetable(averages,['../results/randomSampling_' csoure '_growth_Average_secretion_flux.txt'],'delimiter','\t','QuoteStrings',false)
